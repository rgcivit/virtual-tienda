...
  const scrollToTop = () => {
    // Al hacer clic en el logo, te lleva a la Home, que carga ProductsPage (categoría 'todos')
    navigate('/'); 
    window.scrollTo({
      top: 0,
      behavior: 'smooth',
...
  // 👉 navegación por categoría (CORREGIDO / SIMPLIFICADO)
  const handleCategoryClick = (slug) => {
    // Siempre navegamos a /products y usamos el query param ?category=
    // Esto asegura que ProductsPage siempre sepa qué filtro aplicar.
